---
title: "The Complete LC-3 Execution Lifecycle: From Assembly to CPU Registers"
subtitle: "From .asm to execution: A visual deep-dive into the LC-3 lifecycle. ✨"
pubDate: 2026-03-30
...
tags: ["systems-programming", "computer-architecture", "virtual-machine", "rust", "assembly"]
---
...
The <Tooltip text="A program that converts assembly language code into machine code.">assembler</Tooltip> translates the `.asm` source into a `.obj` binary in exactly **two passes**.
